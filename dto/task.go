...
// TaskError is kept as an alias so legacy task adaptors and the upstream
// plugin contract share one error type during the staged migration.
type TaskError = kitdto.TaskError
