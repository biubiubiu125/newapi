...
type ChannelOtherSettings struct {
	...
	// ToolLossPolicy is a channel-level opt-in for request-phase tool-loss
...
func (s *ChannelOtherSettings) ValidateToolLossPolicy() error {
	...
	switch strings.ToLower(strings.TrimSpace(s.ToolLossPolicy)) {
...
const (
	...
	AdvancedCustomConverterOpenAIResponsesToGeminiGenerateContent       = "openai_responses_to_gemini_generate_content"
...
const (
	...
	advancedCustomConverterClaudeMessagesToOpenAIChat  = AdvancedCustomConverterAnthropicMessagesToOpenAIChatCompletions
	advancedCustomConverterOpenAIChatToClaudeMessages  = AdvancedCustomConverterOpenAIChatCompletionsToAnthropicMessages
	advancedCustomConverterOpenAIChatToOpenAIResponses = AdvancedCustomConverterOpenAIChatCompletionsToOpenAIResponses
	advancedCustomConverterOpenAIResponsesToOpenAIChat = AdvancedCustomConverterOpenAIResponsesToOpenAIChatCompletions
	advancedCustomConverterOpenAIResponsesToGemini     = AdvancedCustomConverterOpenAIResponsesToGeminiGenerateContent
	advancedCustomConverterGeminiContentToOpenAIChat   = AdvancedCustomConverterGeminiGenerateContentToOpenAIChatCompletions
	advancedCustomConverterOpenAIChatToGeminiContent   = AdvancedCustomConverterOpenAIChatCompletionsToGeminiGenerateContent
)
