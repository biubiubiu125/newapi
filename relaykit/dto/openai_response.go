...
func (o *OpenAIResponsesResponse) HasImageGenerationCall() bool {
	return o != nil && o.FirstImageGenerationCall() != nil
}

func (o *OpenAIResponsesResponse) FirstImageGenerationCall() *ResponsesOutput {
	if o == nil {
		return nil
	}
	for i := range o.Output {
		if o.Output[i].Type == ResponsesOutputTypeImageGenerationCall {
			return &o.Output[i]
		}
	}
	return nil
...
func (o *OpenAIResponsesResponse) GetQuality() string {
	if output := o.FirstImageGenerationCall(); output != nil {
