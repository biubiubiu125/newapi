...
func TestValidateRequestURL(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "non-http request scheme", requestURL: "ftp://api.example.com/v1/task", baseURL: "https://api.example.com", wantError: "HTTP(S)"},
		{name: "non-http base scheme", requestURL: "https://api.example.com/v1/task", baseURL: "ftp://api.example.com", wantError: "HTTP(S)"},
		{name: "https base cannot downgrade", requestURL: "http://api.example.com/v1/task", baseURL: "https://api.example.com", wantError: "downgrade"},
		{name: "https approved host cannot downgrade", requestURL: "http://upload.example.com/task", baseURL: "https://api.example.com", allowedHosts: []string{"upload.example.com"}, wantError: "downgrade"},
