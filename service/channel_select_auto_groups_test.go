...
func TestCacheGetRandomSatisfiedChannelExhaustsCurrentAutoGroupBeforeAdvancing(t *testing.T) {
	...
	param.ExcludeChannelIds = []int{first.Id, second.Id}
	param.IncreaseRetry()
