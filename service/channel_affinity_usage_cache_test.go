...
func channelAffinityStatsTestValue(t *testing.T, prefix string) string {
	t.Helper()
	return fmt.Sprintf("%s:%s:%d", prefix, t.Name(), channelAffinityStatsTestSeq.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := channelAffinityStatsTestValue(t, "rule")
	usingGroup := "default"
	keyFP := channelAffinityStatsTestValue(t, "fp")
