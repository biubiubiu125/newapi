...
.PHONY: all build-web build-web-classic build-all-web start-api dev dev-api dev-api-rebuild dev-web reset-setup test
...
build-web-classic:
	...
	@cd ./web/classic && bun install --frozen-lockfile
