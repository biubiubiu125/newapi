...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	channelRoute.POST("/:id/key",
		middleware.RootAuth(),
		middleware.UserCriticalRateLimit("CT:channel-key"),
...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/fetch_models/:id", permission: authz.ChannelSensitiveWrite, handler: controller.FetchUpstreamModels},
	...
	{method: http.MethodGet, path: "/:id/codex/usage", permission: authz.ChannelSensitiveWrite, handler: controller.GetCodexChannelUsage},
	{method: http.MethodGet, path: "/:id/codex/usage/reset-credits", permission: authz.ChannelSensitiveWrite, handler: controller.GetCodexChannelRateLimitResetCredits},
	{method: http.MethodPost, path: "/:id/codex/usage/reset", permission: authz.ChannelSensitiveWrite, handler: controller.ResetCodexChannelUsage},
