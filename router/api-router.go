...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/gmpay/notify", controller.GMPayTopUpNotify)
			userRoute.GET("/gmpay/notify", controller.GMPayTopUpNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/gmpay/assets", controller.GetGMPayAssets)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/gmpay/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestGMPay)
		}
		...
		apiRouter.POST("/subscription/gmpay/notify", controller.SubscriptionGMPayNotify)
