	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/aff_transfer", middleware.UserCriticalRateLimit("UC:aff-transfer"), controller.TransferAffQuota)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/admin/finance/payment-orphans", controller.ListPaymentOrphans)
				adminRoute.POST("/admin/finance/payment-orphans/:id/credit", controller.CreditPaymentOrphan)
				adminRoute.POST("/admin/finance/payment-orphans/:id/resolve", controller.ResolvePaymentOrphan)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/orders/:trade_no/status", controller.GetSubscriptionPaymentStatus)
		...
		systemInfoRoute.Use(middleware.RootAuth())
		{
			...
			systemInfoRoute.DELETE("/instances", controller.DeleteStaleSystemInstance)
