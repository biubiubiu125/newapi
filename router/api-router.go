	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/admin/risk/overview", controller.GetRiskOverview)
				adminRoute.POST("/admin/risk/scan", controller.ScanRiskEvents)
				adminRoute.GET("/admin/risk/events", controller.GetRiskEvents)
				adminRoute.GET("/admin/risk/detail", controller.GetRiskDetail)
				adminRoute.GET("/admin/risk/users", controller.GetRiskUsers)
				adminRoute.POST("/admin/risk/events/:event_id/view", controller.MarkRiskEventViewed)
				adminRoute.POST("/admin/risk/events/:event_id/resolve", controller.ResolveRiskEvent)
				adminRoute.POST("/admin/risk/events/:event_id/ignore", controller.IgnoreRiskEvent)
				adminRoute.POST("/admin/risk/users/:user_id/ban", controller.BanRiskUser)
				adminRoute.POST("/admin/risk/users/:user_id/unban", controller.UnbanRiskUser)
				adminRoute.POST("/admin/risk/tokens/:token_id/disable", controller.DisableRiskToken)
				adminRoute.GET("/admin/risk/actions", controller.GetRiskActions)
				adminRoute.POST("/admin/risk/whitelist", controller.CreateRiskWhitelist)
				adminRoute.DELETE("/admin/risk/whitelist/:id", controller.DeleteRiskWhitelist)
