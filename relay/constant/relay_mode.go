...
func Path2RelayMode(path string) int {
	...
	} else if strings.HasPrefix(path, "/v1/images/generations") || strings.HasPrefix(path, "/v1/image-tasks/generations") {
		relayMode = RelayModeImagesGenerations
	} else if strings.HasPrefix(path, "/v1/images/edits") || strings.HasPrefix(path, "/v1/image-tasks/edits") {
